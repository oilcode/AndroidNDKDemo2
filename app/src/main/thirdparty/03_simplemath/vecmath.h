...
class Vec4 {
 ...
 public:
  ...
  float Dot(const Vec3& rhs) { return x_ * rhs.x + y_ * rhs.y + z_ * rhs.z; }

  Vec3 Cross(const Vec3& rhs) {
    Vec3 ret;
    ret.x = y_ * rhs.z - z_ * rhs.y;
    ret.y = z_ * rhs.x - x_ * rhs.z;
    ret.z = x_ * rhs.y - y_ * rhs.x;
    return ret;
  }
